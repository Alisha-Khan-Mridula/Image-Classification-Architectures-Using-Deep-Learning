...
Original file is located at
    https://colab.research.google.com/drive/1_aWLJ3WkENnkmrGb2mWoAlBEZVY9hs6z
"""
...
train_ds = datagen.flow_from_directory(
    '/content/drive/MyDrive/Alisha Thesis work/Lung cancer dataset/Train',
    target_size=(224, 224),
    batch_size=16,
    color_mode="rgb",
    subset="training",
...
val_ds = datagen.flow_from_directory(
    '/content/drive/MyDrive/Alisha Thesis work/Lung cancer dataset/Test',
    target_size=(224, 224),
    batch_size=16,
    color_mode="rgb",
    subset="validation",
...
test_data_generator = test_generator.flow_from_directory(
    '/content/drive/MyDrive/Alisha Thesis work/Lung cancer dataset/Test',   # Put your path here
    target_size=(224, 224),
    batch_size=16,
    color_mode="rgb",
    shuffle=False)
