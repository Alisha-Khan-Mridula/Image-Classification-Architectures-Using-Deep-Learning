...
Original file is located at
    https://colab.research.google.com/drive/1w70WXQ_u1zCuJiM-lMz-vS4fwEmJgmxk
"""
...
train_ds = datagen.flow_from_directory(
    '/content/drive/MyDrive/Alisha Thesis work/Colon cancer datasets/Train',
    target_size=(224, 224),
    batch_size=16,
    color_mode="rgb",
    subset="training",
...
val_ds = datagen.flow_from_directory(
    '/content/drive/MyDrive/Alisha Thesis work/Colon cancer datasets/Test',
    target_size=(224, 224),
    batch_size=16,
    color_mode="rgb",
    subset="validation",
...
test_data_generator = test_generator.flow_from_directory(
    '/content/drive/MyDrive/Alisha Thesis work/Colon cancer datasets/Test',   # Put your path here
    target_size=(224, 224),
    batch_size=16,
    color_mode="rgb",
    shuffle=False)
